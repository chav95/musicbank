...
<body class="hold-transition sidebar-mini layout-fixed scrollbar-black">
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <router-link to="/" class="brand-link">
      <img src="{{asset('storage/app_image/logo.png')}}" alt="MNC Music Bank Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar scrollbar-black">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <router-link to="/all-music" class="nav-link">
              <i class="fas fa-database nav-icon color-blue"></i>
              <p>All Music</p>
            </router-link>
          </li>
          ...
          <li class="nav-item">
            <router-link to="/wishlist" class="nav-link">
              <i class="nav-icon fas fa-headphones color-purple"></i>
              <p>Wishlist</p>
            </router-link>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item has-treeview">
            <!--<a href="#" class="nav-link active">-->
            <router-link to="/playlist" class="nav-link playlist-container">
              <i class="nav-icon fas fa-compact-disc color-yellow"></i>
              <p>Playlist <i class="right fas fa-angle-left"></i></p>
            </router-link>
